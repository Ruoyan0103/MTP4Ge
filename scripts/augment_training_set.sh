...
# split using scripts/split_test.py (which handles train/val/test assignment).
#
# Usage:
#   bash scripts/augment_training_set.sh data/strained_diamond.xyz [data/sia_configs.xyz ...]
#
...
for XYZ in "$@"; do
    ...
    python src/convert.py --input "$XYZ" --outdir data/
