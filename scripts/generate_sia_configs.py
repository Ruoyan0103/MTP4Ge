...
Run VASP in each directory, then use scripts/collect_dft_results.py.

Usage (from repo root):
    python scripts/generate_sia_configs.py [--outdir data/sia_dft] [--perturb 20]
"""
...
def main():
    ...
    print("  python scripts/collect_dft_results.py --indir data/sia_dft --out data/sia_configs.xyz")
