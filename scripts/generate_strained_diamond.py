...
scripts/collect_dft_results.py to gather results into an XYZ file.

Usage (from repo root):
    python scripts/generate_strained_diamond.py [--outdir data/strained_dft]
"""
...
"""
    ...
    print("  python scripts/collect_dft_results.py --indir data/strained_dft --out data/strained_diamond.xyz")
