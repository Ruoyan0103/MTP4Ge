...
#
# Usage:
#   bash scripts/run_light_tests.sh [pot.almtp]
#
...
# ===========================================================================
#run_test tests/energy_volume.py "energy_volume" --pot "$POT"
...
# ===========================================================================
#run_test tests/defect_formation.py  "defect_formation"  --pot "$POT" --a0 "$A0"
run_test tests/elastic_constants.py "elastic_constants" --pot "$POT" --lattice-constant "$A0"
#run_test tests/quasi_static_drag.py "quasi_static_drag" --pot "$POT" --a0 "$A0"

# ===========================================================================
# Step 3: multiphase_ev — no lattice constant needed
# ===========================================================================
#run_test tests/multiphase_ev.py "multiphase_ev" --pot "$POT"

# ===========================================================================
# Step 4: phonon_dispersion — fixed experimental lattice constant
# ===========================================================================
#run_test tests/phonon_dispersion.py "phonon_dispersion" --pot "$POT" --alat "$PHONON_ALAT"
