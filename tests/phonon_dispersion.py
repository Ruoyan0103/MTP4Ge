...
def run(
    ...
    dft_path = Path("tests/reference/phonon_dispersion_dft.dat")
    exp_path = Path("tests/reference/phonon_dispersion_experimental.dat")
    dft_dos_path = Path("tests/reference/phonon_dos_dft.dat")
